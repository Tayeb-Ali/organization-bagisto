    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.employ-group.create') }}" class="btn btn-lg btn-primary"
                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.employ-group.index') }}" accept-charset="UTF-8"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{ trans('organization::app.employ-group.fields.company_id') }}</th>
                            <th>{{ trans('organization::app.employ-group.fields.group_desc') }}</th>
                            <th>{{ trans('organization::app.employ-group.fields.account_code') }}</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
...
{{--                                <td>{{ $item->company_id}}</td>--}}
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.employ-group.delete', $item->group_id) }}"
