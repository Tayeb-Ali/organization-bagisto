...
@section('page_title')
{{ __('organization::app.supplier.title') }}
@stop
    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.supplier.create') }}" class="btn btn-lg btn-primary" title="Add New Supplier">
                    {{ __('organization::app.supplier.add-title') }}
                </a>
            </div>
        </div>
            ...
            <div class="grid-container">
              ...
              <div class="filter-row-one" id="datagrid-filters">
                ...
                <div class="search-filter">
                  <form method="GET" action="{{ route('admin.supplier.index') }}" accept-charset="UTF-8" class="" style="display: contents;" role="search">
              ...
              <table class="table">
                <thead>
                    <tr>
                        <th>#</th><th>{{ trans('organization::app.supplier.fields.company_id') }}</th><th>{{ trans('organization::app.supplier.fields.group_id') }}</th><th>{{ trans('organization::app.supplier.fields.supp_type') }}</th><th>Actions</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td class="actions" style="white-space: nowrap; width: 100px;">
                          <div class="action">
                            ...
                            <a href="{{ route('admin.supplier.edit', $item->client_id) }}" title="Edit Supplier">
                              <button style="border: none; background-color: inherit;"><span class="icon pencil-lg-icon"></span></button>
                            </a>

                            <form method="POST" action="{{ route('admin.supplier.delete', $item->client_id) }}" accept-charset="UTF-8" style="display:inline">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
              ...
              <div class="pagination"> {!! $supplier->appends(['search' => Request::get('search')])->render() !!} </div>
