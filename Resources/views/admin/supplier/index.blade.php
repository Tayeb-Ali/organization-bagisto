                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.supplier.index') }}" accept-charset="UTF-8"
                            ...
                            <tr>
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        ...
                                        <a href="{{ route('admin.supplier.edit', $item->client_id) }}"
                                           title="Edit Supplier">
                                            <button style="border: none; background-color: inherit;"><span
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.supplier.delete', $item->client_id) }}"
