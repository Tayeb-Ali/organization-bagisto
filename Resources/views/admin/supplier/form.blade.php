            ...
            <div class="control-group col col-6{{ $errors->has('group_id') ? 'has-error' : ''}}">
                ...
                <select id="company_branch_id" name="company_branch_id" class="form-control control" data-role="control">
                    ...
                    @foreach($company as $item)
                        <option value="{{ $item->company_id }}" {{$supplier->company_branch_id == $item->company_id ? 'selected' : '' }}>{{ $item->description}}</option>
                    @endforeach
                </select>
        ...
        <div class="row">
            ...
            <div class="control-group col-6 {{ $errors->has('status') ? 'has-error' : ''}}">
                ...
                <select id="status" name="status" class="form-control control" data-role="control">
                    <option value="2" {{$supplier->status == 2 ? 'selected' : '' }}>{{__('organization::app.status.Inactive')}}</option>
                    <option value="1" {{$supplier->status ==1 ? 'selected' : '' }}>{{__('organization::app.status.Active')}}</option>
                </select>
