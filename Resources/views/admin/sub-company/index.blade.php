                        ...
                        @foreach($company as $item)
                            <tr>
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
{{--                                        <a href="{{ route('admin.company.sub_company.show', $item->company_id) }}"--}}
{{--                                           title="View Company">--}}
{{--                                            <button style="border: none; background-color: inherit;"><span--}}
{{--                                                        class="icon eye-icon"></span></button>--}}
{{--                                        </a>--}}
                                        <a href="{{ route('admin.sub_company.edit', $item->company_id) }}"
                                           title="Edit Company">
                                            <button style="border: none; background-color: inherit;"><span
...
{{--                                        <form method="POST"--}}
{{--                                              action="{{ route('admin.company.sub_company.delete', $item->company_id) }}"--}}
