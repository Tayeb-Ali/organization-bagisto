<accordian :title="'{{ __('organization::app.clientgroup.general') }}'" :active="true">
    <div slot="body">
      ...
      <div class="control-group {{ $errors->has('company_id') ? 'has-error' : ''}}">
        <label for="company_id" class="required">{{ __('organization::app.clientgroup.fields.company_id') }}</label>

        <input class="control" name="company_id" type="number" id="company_id" value="{{ isset($clientgroup->company_id) ? $clientgroup->company_id : ''}}" required>

          {!! $errors->first('company_id', '<span class="control-error">:message</span>') !!}
      </div>
      <div class="control-group {{ $errors->has('group_desc') ? 'has-error' : ''}}">
        <label for="group_desc" class="required">{{ __('organization::app.clientgroup.fields.group_desc') }}</label>

        <input class="control" name="group_desc" type="text" id="group_desc" value="{{ isset($clientgroup->group_desc) ? $clientgroup->group_desc : ''}}" required>
      ...
      <div class="control-group {{ $errors->has('account_code') ? 'has-error' : ''}}">
        ...
        <input class="control" name="account_code" type="text" id="account_code" value="{{ isset($clientgroup->account_code) ? $clientgroup->account_code : ''}}" >
      ...
      <div class="control-group {{ $errors->has('status') ? 'has-error' : ''}}">
        ...
        <input class="control" name="status" type="text" id="status" value="{{ isset($clientgroup->status) ? $clientgroup->status : ''}}" >
      ...
      <div class="control-group {{ $errors->has('amend_by') ? 'has-error' : ''}}">
        ...
        <input class="control" name="amend_by" type="text" id="amend_by" value="{{ isset($clientgroup->amend_by) ? $clientgroup->amend_by : ''}}" >
      ...
      <div class="control-group {{ $errors->has('amend_date') ? 'has-error' : ''}}">
        ...
        <input class="control" name="amend_date" type="datetime-local" id="amend_date" value="{{ isset($clientgroup->amend_date) ? $clientgroup->amend_date : ''}}" >
