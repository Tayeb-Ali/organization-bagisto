    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.client-group.create') }}" class="btn btn-lg btn-primary"
                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.client-group.index') }}" accept-charset="UTF-8"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>#</th>
{{--                            <th>{{ trans('organization::app.clientgroup.fields.company_id') }}</th>--}}
                            <th>{{ trans('organization::app.clientgroup.fields.group_desc') }}</th>
                            <th>{{ trans('organization::app.clientgroup.fields.account_code') }}</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
...
{{--                                @endif--}}
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.client-group.delete', $item->group_id) }}"
