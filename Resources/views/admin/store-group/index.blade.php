...
@section('page_title')
    {{ __('organization::app.store-group.title') }}
@stop
    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.store-group.create') }}" class="btn btn-lg btn-primary"
                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.store-group.index') }}" accept-charset="UTF-8"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{ trans('organization::app.store-group.fields.group_desc') }}</th>
                            <th>{{ trans('organization::app.store-group.fields.company_id') }}</th>
                            <th>{{ trans('organization::app.store-group.fields.status') }}</th>
                            <th>Actions</th>
                        </tr>
                        </thead>

                        <tbody>
                        @foreach($storeGroup as $item)
                            <tr>
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.store-group.delete', $item->group_id) }}"
                    ...
                    <div class="pagination"> {!! $storeGroup->appends(['search' => Request::get('search')])->render() !!} </div>
