    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.company-branch.create') }}" class="btn btn-lg btn-primary"
                   title="Add New CompanyBranch">
                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.company-branch.index') }}" accept-charset="UTF-8"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{ trans('organization::app.companybranch.fields.company_id') }}</th>
                            <th>{{ trans('organization::app.companybranch.fields.short_desc') }}</th>
                            <th>{{ trans('organization::app.companybranch.fields.description') }}</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($companybranch as $item)
                            <tr>
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        <a href="{{ route('admin.company-branch.show', $item->branch_id) }}"
                                           title="View CompanyBranch">
                                            <button style="border: none; background-color: inherit;"><span
                                                        class="icon eye-icon"></span></button>
                                        </a>
                                        <a href="{{ route('admin.company-branch.edit', $item->branch_id) }}"
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.company-branch.delete', $item->branch_id) }}"
                                              accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" style="border: none; background-color: inherit;"
                                                    title="Delete CompanyBranch"
