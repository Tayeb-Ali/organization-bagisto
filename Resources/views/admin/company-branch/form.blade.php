<accordian :title="'{{ __('organization::app.companybranch.general') }}'" :active="true">
    <div slot="body">
      ...
      <div class="control-group {{ $errors->has('company_id') ? 'has-error' : ''}}">
        ...
        <input class="control" name="company_id" type="number" id="company_id" value="{{ isset($companybranch->company_id) ? $companybranch->company_id : ''}}" >

          {!! $errors->first('company_id', '<span class="control-error">:message</span>') !!}
      </div>
      <div class="control-group {{ $errors->has('short_desc') ? 'has-error' : ''}}">
        <label for="short_desc" class="required">{{ __('organization::app.companybranch.fields.short_desc') }}</label>

        <input class="control" name="short_desc" type="text" id="short_desc" value="{{ isset($companybranch->short_desc) ? $companybranch->short_desc : ''}}" required>
      ...
      <div class="control-group {{ $errors->has('description') ? 'has-error' : ''}}">
        ...
        <input class="control" name="description" type="text" id="description" value="{{ isset($companybranch->description) ? $companybranch->description : ''}}" >
      ...
      <div class="control-group {{ $errors->has('branch_country') ? 'has-error' : ''}}">
        <label for="branch_country" class="">{{ __('organization::app.companybranch.fields.branch_country') }}</label>

        <input class="control" name="branch_country" type="text" id="branch_country" value="{{ isset($companybranch->branch_country) ? $companybranch->branch_country : ''}}" >
      ...
      <div class="control-group {{ $errors->has('branch_weight') ? 'has-error' : ''}}">
        ...
        <input class="control" name="branch_weight" type="number" id="branch_weight" value="{{ isset($companybranch->branch_weight) ? $companybranch->branch_weight : ''}}" >
      ...
      <div class="control-group {{ $errors->has('branch_manager') ? 'has-error' : ''}}">
        <label for="branch_manager" class="">{{ __('organization::app.companybranch.fields.branch_manager') }}</label>

        <input class="control" name="branch_manager" type="text" id="branch_manager" value="{{ isset($companybranch->branch_manager) ? $companybranch->branch_manager : ''}}" >
      ...
      <div class="control-group {{ $errors->has('currency') ? 'has-error' : ''}}">
        ...
        <input class="control" name="currency" type="text" id="currency" value="{{ isset($companybranch->currency) ? $companybranch->currency : ''}}" >
      ...
      <div class="control-group {{ $errors->has('status') ? 'has-error' : ''}}">
        ...
        <input class="control" name="status" type="text" id="status" value="{{ isset($companybranch->status) ? $companybranch->status : ''}}" >
      ...
      <div class="control-group {{ $errors->has('amend_by') ? 'has-error' : ''}}">
        ...
        <input class="control" name="amend_by" type="text" id="amend_by" value="{{ isset($companybranch->amend_by) ? $companybranch->amend_by : ''}}" >
      ...
      <div class="control-group {{ $errors->has('amend_date') ? 'has-error' : ''}}">
        ...
        <input class="control" name="amend_date" type="datetime-local" id="amend_date" value="{{ isset($companybranch->amend_date) ? $companybranch->amend_date : ''}}" >
      ...
      <div class="control-group {{ $errors->has('phone') ? 'has-error' : ''}}">
        ...
        <input class="control" name="phone" type="text" id="phone" value="{{ isset($companybranch->phone) ? $companybranch->phone : ''}}" >
      ...
      <div class="control-group {{ $errors->has('fax') ? 'has-error' : ''}}">
        ...
        <input class="control" name="fax" type="text" id="fax" value="{{ isset($companybranch->fax) ? $companybranch->fax : ''}}" >
      ...
      <div class="control-group {{ $errors->has('email') ? 'has-error' : ''}}">
        ...
        <input class="control" name="email" type="text" id="email" value="{{ isset($companybranch->email) ? $companybranch->email : ''}}" >
      ...
      <div class="control-group {{ $errors->has('cost_center') ? 'has-error' : ''}}">
        ...
        <input class="control" name="cost_center" type="text" id="cost_center" value="{{ isset($companybranch->cost_center) ? $companybranch->cost_center : ''}}" >
      ...
      <div class="control-group {{ $errors->has('ship_to_address') ? 'has-error' : ''}}">
        <label for="ship_to_address" class="">{{ __('organization::app.companybranch.fields.ship_to_address') }}</label>

        <input class="control" name="ship_to_address" type="text" id="ship_to_address" value="{{ isset($companybranch->ship_to_address) ? $companybranch->ship_to_address : ''}}" >
      ...
      <div class="control-group {{ $errors->has('ship_to_phone') ? 'has-error' : ''}}">
        ...
        <input class="control" name="ship_to_phone" type="text" id="ship_to_phone" value="{{ isset($companybranch->ship_to_phone) ? $companybranch->ship_to_phone : ''}}" >
      ...
      <div class="control-group {{ $errors->has('ship_to_fax') ? 'has-error' : ''}}">
        ...
        <input class="control" name="ship_to_fax" type="text" id="ship_to_fax" value="{{ isset($companybranch->ship_to_fax) ? $companybranch->ship_to_fax : ''}}" >
      ...
      <div class="control-group {{ $errors->has('ship_to_city') ? 'has-error' : ''}}">
        ...
        <input class="control" name="ship_to_city" type="text" id="ship_to_city" value="{{ isset($companybranch->ship_to_city) ? $companybranch->ship_to_city : ''}}" >
      ...
      <div class="control-group {{ $errors->has('ship_to_country') ? 'has-error' : ''}}">
        <label for="ship_to_country" class="">{{ __('organization::app.companybranch.fields.ship_to_country') }}</label>

        <input class="control" name="ship_to_country" type="text" id="ship_to_country" value="{{ isset($companybranch->ship_to_country) ? $companybranch->ship_to_country : ''}}" >
      ...
      <div class="control-group {{ $errors->has('bill_to_address') ? 'has-error' : ''}}">
        <label for="bill_to_address" class="">{{ __('organization::app.companybranch.fields.bill_to_address') }}</label>

        <input class="control" name="bill_to_address" type="text" id="bill_to_address" value="{{ isset($companybranch->bill_to_address) ? $companybranch->bill_to_address : ''}}" >
      ...
      <div class="control-group {{ $errors->has('bill_to_phone') ? 'has-error' : ''}}">
        ...
        <input class="control" name="bill_to_phone" type="text" id="bill_to_phone" value="{{ isset($companybranch->bill_to_phone) ? $companybranch->bill_to_phone : ''}}" >
      ...
      <div class="control-group {{ $errors->has('bill_to_fax') ? 'has-error' : ''}}">
        ...
        <input class="control" name="bill_to_fax" type="text" id="bill_to_fax" value="{{ isset($companybranch->bill_to_fax) ? $companybranch->bill_to_fax : ''}}" >
      ...
      <div class="control-group {{ $errors->has('bill_to_city') ? 'has-error' : ''}}">
        ...
        <input class="control" name="bill_to_city" type="text" id="bill_to_city" value="{{ isset($companybranch->bill_to_city) ? $companybranch->bill_to_city : ''}}" >
      ...
      <div class="control-group {{ $errors->has('bill_to_country') ? 'has-error' : ''}}">
        <label for="bill_to_country" class="">{{ __('organization::app.companybranch.fields.bill_to_country') }}</label>

        <input class="control" name="bill_to_country" type="text" id="bill_to_country" value="{{ isset($companybranch->bill_to_country) ? $companybranch->bill_to_country : ''}}" >
