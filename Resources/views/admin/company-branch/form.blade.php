    ...
    <div slot="body">
        ...
        <div class="row">
            <div class="control-group {{ $errors->has('branch_weight') ? 'has-error' : ''}}">
                <label for="branch_weight"
                       class="">{{ __('organization::app.companybranch.fields.branch_weight') }}</label>
        ...
        <div class="row">
            ...
            <div class="control-group {{ $errors->has('ship_to_phone') ? 'has-error' : ''}}">
                <label for="ship_to_phone"
                       class="">{{ __('organization::app.companybranch.fields.ship_to_phone') }}</label>
        ...
        <div class="row">
            ...
            <div class="control-group {{ $errors->has('ship_to_city') ? 'has-error' : ''}}">
                <label for="ship_to_city"
                       class="">{{ __('organization::app.companybranch.fields.ship_to_city') }}</label>
        ...
        <div class="row">
            ...
            <div class="control-group {{ $errors->has('bill_to_phone') ? 'has-error' : ''}}">
                <label for="bill_to_phone"
                       class="">{{ __('organization::app.companybranch.fields.bill_to_phone') }}</label>
        ...
        <div class="row">
            <div class="control-group {{ $errors->has('bill_to_city') ? 'has-error' : ''}}">
                <label for="bill_to_city"
                       class="">{{ __('organization::app.companybranch.fields.bill_to_city') }}</label>
