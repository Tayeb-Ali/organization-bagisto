<accordian :title="'{{ __('organization::app.employ.general') }}'" :active="true">
    <div slot="body">
        ...
        <div class="control-group {{ $errors->has('group_id') ? 'has-error' : ''}}">
            <label for="group_id" class="required">{{ __('organization::app.employ.fields.group_id') }}</label>

            <input class="control" name="group_id" type="number" id="group_id"
                   value="{{ isset($employ->group_id) ? $employ->group_id : ''}}" required>
        ...
        <div class="control-group {{ $errors->has('fax') ? 'has-error' : ''}}">
            ...
            <input class="control" name="fax" type="text" id="fax" value="{{ isset($employ->fax) ? $employ->fax : ''}}">
        ...
        <div class="control-group {{ $errors->has('begin_bal_credit') ? 'has-error' : ''}}">
            <label for="begin_bal_credit" class="">{{ __('organization::app.employ.fields.begin_bal_credit') }}</label>
        ...
        <div class="control-group {{ $errors->has('begin_bal_debit') ? 'has-error' : ''}}">
            <label for="begin_bal_debit" class="">{{ __('organization::app.employ.fields.begin_bal_debit') }}</label>
        ...
        <div class="control-group {{ $errors->has('curr_bal_credit') ? 'has-error' : ''}}">
            <label for="curr_bal_credit" class="">{{ __('organization::app.employ.fields.curr_bal_credit') }}</label>
        ...
        <div class="control-group {{ $errors->has('last_trns_value') ? 'has-error' : ''}}">
            <label for="last_trns_value" class="">{{ __('organization::app.employ.fields.last_trns_value') }}</label>
        ...
        <div class="control-group {{ $errors->has('mship_to_address') ? 'has-error' : ''}}">
            <label for="mship_to_address" class="">{{ __('organization::app.employ.fields.mship_to_address') }}</label>
