    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('admin.supplier-group.create') }}" class="btn btn-lg btn-primary"
                   title="Add New SupplierGroup">
                ...
                <div class="grid-container">
                    ...
                    <div class="filter-row-one" id="datagrid-filters">
                        ...
                        <div class="search-filter">
                            <form method="GET" action="{{ route('admin.supplier-group.index') }}" accept-charset="UTF-8"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{ trans('organization::app.suppliergroup.fields.company_id') }}</th>
                            <th>{{ trans('organization::app.suppliergroup.fields.group_desc') }}</th>
                            <th>{{ trans('organization::app.suppliergroup.fields.account_code') }}</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($suppliergroup as $item)
                            <tr>
                                ...
                                <td class="actions" style="white-space: nowrap; width: 100px;">
                                    <div class="action">
                                        <a href="{{ route('admin.supplier-group.show', $item->group_id) }}"
                                           title="View SupplierGroup">
                                            <button style="border: none; background-color: inherit;"><span
                                                        class="icon eye-icon"></span></button>
                                        </a>
                                        <a href="{{ route('admin.supplier-group.edit', $item->group_id) }}"
                                        ...
                                        <form method="POST"
                                              action="{{ route('admin.supplier-group.delete', $item->group_id) }}"
                                              accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" style="border: none; background-color: inherit;"
                                                    title="Delete SupplierGroup"
